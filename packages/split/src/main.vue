  ...
  <div class="el-split">
    <div ref="outerWrapper" :class="wrapperClasses">
      <div v-if="isHorizontal" :class="`${prefix}-horizontal`">
        <div :style="{right: `${anotherOffset}%`}" class="left-pane" :class="paneClasses" style="right: 50%;">
          <slot name="left"/>
        </div>
...
<script>
import {oneOf} from 'element-ui/src/utils/split/assist';
import {on, off} from 'element-ui/src/utils/split/evt';
